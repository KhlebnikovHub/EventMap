...
function Events() {
  ...
  const submitHandler = async (event) => {
    ...
    const responseData = await fetch(
      `${process.env.REACT_APP_API_URL}/event/newEvent`,
      {
        method: "POST",
    ...
    const responseImage = await fetch(
      `${process.env.REACT_APP_API_URL}/event/newEvent/${responseDataId}`,
      {
        method: "POST",
        body: formData,
      }
  ...
  return (
    <div className="App">
      <div className={style.events__modalWrapper}>
      ...
      <div className={style.events__modalButton}>
            ...
            <Clusterer
              ...
              options={{
                ...
                clusterIcons: [
                  ...
                  {
                    href:
                      "https://cdn4.vectorstock.com/i/1000x1000/20/73/black-cat-icon-flat-vector-11112073.jpg",
                    size: [60, 60],
                    offset: [-30, -30],
                  },
                ],
                  ...
                  instanceRef={(ref) => {
                    if (ref) {
                      ...
                      for (let cluster in clusters) {
                        ...
                        console.log(
                          "ICOOOOOOOOOOOOOON",
                          clusters[cluster].clusterObject?.options
                        );
                        if (clusters[cluster].clusterObject?.options) {
                          ...
                          clusters[cluster].clusterObject?.options.set(
                            "clusterIconContentLayout",
                            supercustom.template
                          );
